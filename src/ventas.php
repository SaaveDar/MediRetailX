                ...
                <form method="post">
                    <div class="row">
                        <!--<div class="col-md-2">
                            <div class="form-group">
                                <label>DNI</label>
                                <input type="number" name="doc_cliente" id="doc_cliente" class="form-control" placeholder="DNI del cliente:" required>
                            </div>
                        </div>-->
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label for="codmed">Código Med.</label>
                            <input id="codmed" class="form-control" type="text" name="codmed" placeholder="@codigo" readonly>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            ...
                            S/.<input id="sub_total" class="form-control" type="text" name="sub_total" placeholder="Sub Total" disabled>
                        </div>
                    </div>
                </div>
